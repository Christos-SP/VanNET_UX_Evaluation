...
Οι παράμετροι αυτοί, θα μας βοηθήσουν να αξιολογήσουμε πόσο εύχρηστη είναι η εφαρμογή VanNET και σε επόμενο στάδιο, να βελτιώσουμε την ευχρηστία της, μέσω στοχευμένων παρεμβάσεων. Για την καταγραφή των παραπάνω παραμέτρων με αντικειμενικό και αμερόληπτο τρόπο, χρησιμοποιούμε την δωρεάν εφαρμογή Mousotron, την οποία σας ζητούμε να κατεβάσετε και να εγκαταστήσετε στον υπολογιστή σας.  
